...
namespace Pledger.Data
{
    public class PledgeProcessor
    {
        ...
        //alandias new method to pledge 20150714
        public void PledgeStocks(Dictionary<string,int> CusipQtyList, string source, string clearingNo, bool sendToApex, bool sendToDTC)
        {
            ...
            foreach (var item in CusipQtyList)
            {
                ...
                if (string.IsNullOrEmpty(item.Key) || item.Value < 1) { return; }
            }
            ...
            foreach (var item in CusipQtyList)
            {
                ...
                double qty = item.Value;

                //Loan value is needed if we put in blob.slate.pledge
                double price = 0;
                double LoanValue = qty * price;
                ...
                {
                    //PDA.Insert(SlatePledgeItem);  insert into blob.slate.dbo.pledge
            ...
            */
            ...
            if (sendToG1)
            {
                ...
                */
                ...
                ReturnedG1ID =
                tc.CreateTrade(source, internalid, GetLegalEntity(stp.RealTimePosition.ParticipantNum),
                    EID, "CP", "GC", "OCC", "OCC-MS0269", stp.RealTimePosition.cusip,
                    DateTime.Today, null, stp.QuantityToPledge, 0, 0, .0000001, Environment.UserName, DateTime.Today, 100, 0,
                    null, "DTC0269", null, "OCC", "USD", true, true);
