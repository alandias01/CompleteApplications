...
{
    public class spHeliumDataForContractCompareLoanetFileObject
    {
        ...
        public string LoanNetMark_Rounding_FACTOR_NewZ4Spec { get; set; }

        #endregion

        
        public spHeliumDataForContractCompareLoanetFileObject(SqlDataReader row)
        {            
            ...
            LoanNetMark_Rounding_FACTOR_NewZ4Spec = row["LoanNetMark_Rounding_FACTOR_NewZ4Spec"] == DBNull.Value ? LoanNetMark_Rounding_FACTOR_NewZ4Spec : (string)row["LoanNetMark_Rounding_FACTOR_NewZ4Spec"];
        ...
        public spHeliumDataForContractCompareLoanetFileObject()
        {
        ...
        public spHeliumDataForContractCompareLoanetFileObject(spHeliumDataForContractCompareLoanetFileObject x)
        {
            ...
            this.LoanNet_Eligable = x.LoanNet_Eligable;
            ...
            this.LoanNetMark_Rounding_FACTOR_NewZ4Spec = x.LoanNetMark_Rounding_FACTOR_NewZ4Spec;
            
        }
        
        public void Replicate(spHeliumDataForContractCompareLoanetFileObject x)
        {
            this.BookName = x.BookName;
            this.CPTY = x.CPTY;
            this.NAME = x.NAME;
        ...
        private void CheckIfNull()
        {
            ...
            if (string.IsNullOrEmpty(LoanNetMark_Rounding_FACTOR_NewZ4Spec)) { LoanNetMark_Rounding_FACTOR_NewZ4Spec = "X"; WriteErrors("CheckIfNull", "LoanNetMark_Rounding_FACTOR_NewZ4Spec"); }
        }
